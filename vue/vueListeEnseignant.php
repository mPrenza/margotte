        ...
        <nav id="navGauche">
            <ul>
                <h4 id="titreMenuNav">Menu principal<h4>
                        ...
                        <li class="menuP" id="listeEnseignants"><a href="#">Liste enseignants</a></li>
                        <li class="menuP" id="listeEleves"><a href="#">Liste eleves</a></li>
...
// Creation et envoi de la requete
                            $query = "SELECT NOM,PRENOM,F.LIBFILIERE FROM PERSONNE P INNER JOIN FILIERE F ON F.IDRESP=P.IDPERS ORDER BY F.LIBFILIERE";
